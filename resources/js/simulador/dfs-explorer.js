...
/**
 * Orquesta el vuelo tramo por tramo respetando los tiempos de espera en tierra
 */
/**
 * Orquesta el vuelo tramo por tramo respetando los tiempos de espera en tierra
 */
...
//             scaledSize: new google.maps.Size(36, 36), // Un toque más chico para el explorador DFS
//             anchor: new google.maps.Point(18, 18),     // Centro exacto del eje de giro (36 / 2)
//             rotation: 0
//         }
//     });
...
//                     // Reseteamos rotación al reiniciar el viaje completo
...
//                             // 🌟 SELECTOR QUIRÚRGICO: Buscamos el elemento contenedor que tiene el título de este tramo específico
//                             // Google Maps pone el 'title' en el contenedor del marcador (un div) que envuelve a la imagen
//                             const selectorContenedor = `div[title="${claveTramo}"] img[src*="${planeIconUrl}"]`;
//                             const elementosAvion = document.querySelectorAll(selectorContenedor);
                            
//                             elementosAvion.forEach(el => {
